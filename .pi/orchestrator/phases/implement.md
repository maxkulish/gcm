...
phase** - gcm has no separate `review` phase.
...
```bash
"$HOME/bin/session-knowledge" search <keywords for the touched modules>
```
...
This is the gcm equivalent of the mentis `review` phase. It is a
**bounded** gate:
