...
> **CLO-488** (typed errors + retries, PR #6) and **CLO-491** (plan cache) are both in progress. **CLO-489**, **CLO-490**, **CLO-493** remain ready; the provider chain (CLO-489) runs in parallel. CLO-492 still waits on CLO-488; CLO-497 waits on the rest.
