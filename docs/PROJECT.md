...
> CLO-491 (plan cache) merged (PR #7). **CLO-488** (typed errors + retries) merged (PR #6, `9052a7e`) — post-merge sync pending in its own workflow. **CLO-489** (provider trait + Gemini + OpenAI) is at **PR #10** (CI green; awaiting merge) and unblocks CLO-494/495/496. **CLO-492** (validation + fallback) started — Spec phase. **CLO-490**, **CLO-493** remain ready. CLO-497 waits on the rest of the feature set.
